				...
				<div class="right_col" role="main">
		            ...
		            <div class='row'>
						<div class="col-md-12 col-sm-12 col-xs-12">
							<form:form modelAttribute="addCustomerForm">
								<div class="x_panel">
									<div class="x_title">
										...
										<div class="form-horizontal form-label-left input_mask">
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<form:input id="name" path="name" type="text" class="form-control col-md-7 col-xs-12"/>
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12"
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<form:input id="secondaryName" path="secondaryName"
											...
											<div class="form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12"
													for="customerDate">Customer since </label>
												<div class="col-md-6 col-sm-6 col-xs-12">
											...
											<div class="form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12"
													for="post">Post </label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<form:input id="post" path="post" type="text"
														class="form-control col-md-7 col-xs-12" />
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12"
													for="pin">Pin </label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<form:input id="pin" path="pin" type="text"
														class="form-control col-md-7 col-xs-12" />
												</div>
											</div>
											<div class="form-group">
